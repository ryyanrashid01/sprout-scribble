...
export default function VariantImages() {
  ...
  return (
    <div className="overflow-x-hidden">
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <FormControl>
              <UploadDropzone
                className="ut-allowed-content:text-secondary-foreground ut-label:text-primary ut-upload-icon:text-primary/50 hover:bg-primary/10 transition-all duration-500 ease-in-out border-secondary ut-button:bg-secondary/75 ut-button:ut-readying:bg-secondary"
                onUploadError={(error) => {
                  console.log(error);
      ...
      />
      {fields.length > 1 && (
        <p className="text-sm mt-4 text-center italic scale-90">
